...
const {createSub, getSubs, getSub, getUserSubs, updateSub, deleteSub, subUser, cancel, getUserSub, getGymUserSubs,revokeUserAccess, grantUserAccess} = require('../controllers/subscriptionController')
...
router.route('/revokeUserAccess/').post(auth,revokeUserAccess);
router.route('/grantUserAccess/').post(auth,grantUserAccess);
